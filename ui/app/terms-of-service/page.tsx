        ...
        <div className="container mx-auto px-4 py-12">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-muted-foreground">Please read these terms carefully before using our service</p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-8">
              <div className="prose prose-blue max-w-none">
                ...
                <p>
                  These Terms of Service ("Terms") constitute a legally binding agreement between you and CardioGuard
                  ("Company," "we," "us," or "our") governing your access to and use of the CardioGuard website, including
                  any content, functionality, and services offered on or through cardioguard.com (the "Service").
                </p>
                <p>
                ...
                <h2 className="text-2xl font-semibold mt-8 mb-4">2. Changes to the Terms</h2>
                <p>
                ...
                <p>
                  Your continued use of the Service following the posting of revised Terms means that you accept and agree
                  to the changes. You are expected to check this page frequently so you are aware of any changes, as they
                  are binding on you.
                </p>
  
                <h2 className="text-2xl font-semibold mt-8 mb-4">3. Accessing the Service and Account Security</h2>
                <p>
                  We reserve the right to withdraw or amend the Service, and any service or material we provide on the
                ...
                <ul className="list-disc pl-5 space-y-2 mb-4">
                  ...
                  <li>
                    Ensuring that all persons who access the Service through your internet connection are aware of these
                    Terms and comply with them.
                  </li>
                  <li>Keeping your account credentials confidential and restricting access to your account.</li>
                </ul>
                <p>
                  You agree to notify us immediately of any unauthorized access to or use of your username or password or
                ...
                <p>
                  <strong>
                    THE SERVICE IS NOT INTENDED TO PROVIDE MEDICAL ADVICE, DIAGNOSIS, OR TREATMENT. THE SERVICE IS NOT A
                    SUBSTITUTE FOR PROFESSIONAL MEDICAL ADVICE, DIAGNOSIS, OR TREATMENT.
                  </strong>
                </p>
                <p>
                  The content on the Service, including text, graphics, images, and information obtained from third
                  parties, licensors, and other content providers, is for informational purposes only. The content is not
                ...
                <p>
                  If you think you may have a medical emergency, call your doctor or emergency services immediately. We do
                ...
                <p>
                  Reliance on any information provided by the Service, Company employees, others appearing on the Service
                  at the invitation of the Company, or other visitors to the Service is solely at your own risk.
                </p>
                ...
                <p>
                  These Terms permit you to use the Service for your personal, non-commercial use only. You must not
                  reproduce, distribute, modify, create derivative works of, publicly display, publicly perform,
                  republish, download, store, or transmit any of the material on our Service, except as follows:
                </p>
                <ul className="list-disc pl-5 space-y-2 mb-4">
                  <li>
                ...
                <ul className="list-disc pl-5 space-y-2 mb-4">
                  ...
                  <li>
                    Access or use for any commercial purposes any part of the Service or any services or materials
                ...
                <h2 className="text-2xl font-semibold mt-8 mb-4">7. User Contributions</h2>
                <p>
                  The Service may contain message boards, chat rooms, personal web pages or profiles, forums, bulletin
                  boards, and other interactive features (collectively, "Interactive Services") that allow users to post,
                ...
                <p>
                  ...
                  Contribution you post to the Service will be considered non-confidential and non-proprietary.
                </p>
                <p>
                  You represent and warrant that you own or control all rights in and to the User Contributions and have
                  the right to grant the license granted above to us and our affiliates and service providers, and each of
                  their and our respective licensees, successors, and assigns.
                </p>
  
                <h2 className="text-2xl font-semibold mt-8 mb-4">8. Monitoring and Enforcement; Termination</h2>
                <p>We have the right to:</p>
                <ul className="list-disc pl-5 space-y-2 mb-4">
                  <li>Remove or refuse to post any User Contributions for any or no reason in our sole discretion.</li>
                  <li>
                    Take any action with respect to any User Contribution that we deem necessary or appropriate in our
                    sole discretion.
                  </li>
                  <li>
                    Terminate or suspend your access to all or part of the Service for any or no reason, including without
                ...
                <p>
                  ...
                  ANY LEGAL THEORY, ARISING OUT OF OR IN CONNECTION WITH YOUR USE, OR INABILITY TO USE, THE SERVICE, ANY
                ...
                <p>
                  All matters relating to the Service and these Terms, and any dispute or claim arising therefrom or
                  related thereto, shall be governed by and construed in accordance with the internal laws of the State of
                  California without giving effect to any choice or conflict of law provision or rule.
                </p>
                <p>
                  ...
                  California, in each case located in the City of San Francisco and County of San Francisco. You waive any
                  and all objections to the exercise of jurisdiction over you by such courts and to venue in such courts.
                </p>
  
                <h2 className="text-2xl font-semibold mt-8 mb-4">12. Waiver and Severability</h2>
                <p>
                  No waiver by the Company of any term or condition set out in these Terms shall be deemed a further or
                  continuing waiver of such term or condition or a waiver of any other term or condition, and any failure
                  of the Company to assert a right or provision under these Terms shall not constitute a waiver of such
                  right or provision.
                </p>
                <p>
                ...
                <p>
                  The Terms constitute the sole and entire agreement between you and CardioGuard regarding the Service and
                ...
                <p>
                  ...
                  should be directed to: support@cardioguard.com.
                </p>
              </div>
            </div>
          </div>
